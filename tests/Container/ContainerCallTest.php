...
class ContainerTestCallStub
{
    ...
    public function inject(ContainerCallConcreteStub $stub, $default = 'taylor'): array
    {
        return func_get_args();
    }

    public function unresolvable($foo, $bar): array
    {
        return func_get_args();
    }
}
...
{
    public static function inject(ContainerCallConcreteStub $stub, $default = 'taylor'): array
    {
        return func_get_args();
    }
}
