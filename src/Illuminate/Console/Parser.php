...
/**
 * ponytail: BC shim — parses the v13 `$signature` DSL so v13-style commands
 * (illuminate/database, session, cache console commands) register their
 * arguments/options while running on the not-yet-swapped fork console.
 * Mirrors Illuminate\Console\Parser from v13. Remove at the console swap (task 4.2).
 */
class Parser {
