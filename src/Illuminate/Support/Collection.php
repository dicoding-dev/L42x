 ...
 */
class Collection implements ArrayAccess, ArrayableInterface, CanBeEscapedWhenCastToString, Enumerable, JsonableInterface
{
    /**
    ...
    // ponytail: Laravel 4.2 holdovers kept so the fork's Database layer and existing
    // callers keep working across the L13 shape change; removed in migration task 2.5
    // (lists → pluck, fetch → pluck) once app call-sites are converted.
